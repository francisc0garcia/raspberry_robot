...
class RobotController:
    ...
    def get_position(self):
        pos_x = self.robot_position_x
        pos_y = self.robot_position_y

        return [pos_x, pos_y, self.robot_yaw]

    def get_target_position(self):
        pos_x = self.target_position_x
        pos_y = self.target_position_y
    ...
    def move_rotate(self, linear_velocity, angular_velocity):
        # create Twist message
        cmd = Twist()
        cmd.linear.x = linear_velocity
